        ...
        <div className="bg-primary-90 lg:bg-transparent">
            <div className="container px-5 lg:px-20">
                <div className="text-center">
                    <h2 className="text-2xl lg:text-[40px] font-bold mb-4 text-gray-10">See What Our Satisfied Professionals are Saying</h2>
                    <p className="text-xl text-gray-30">Hear what home service professionals have to say about Loggworks.</p>
                </div>
