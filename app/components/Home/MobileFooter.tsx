  ...
  return (
    <div className="bg-[#1D1D1D] text-gray--100 py-8 px-5 lg:hidden">
      <div className="flex flex-col pb-10 justify-center items-center">
        ...
        <Button className="py-6 w-full mb-4 border bg-transparent">
          Become a Professional
        </Button>
        <Button className="py-6 w-full mb-6 border bg-transparent">
          Post a Job
        </Button>
      </div>

      <main className="flex flex-col border-b border-gray-500">
